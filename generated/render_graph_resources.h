...
struct RGCullInstance
{
	...
	const u32 numResources = 7;
	const u32 numBuffers = 6;
	const u32 numTextures = 1;
	const ShaderParamFlags flags = ShaderParamFlags::Compute | ShaderParamFlags::Push;
	const PassResource textureResources[1] = {
		{graphics::ResourceViewType::SRV, HLSLType::Texture2D, 0},
	};
...
struct RGMeshHeader
{
	...
	const u32 numBuffers = 0;
	const u32 numTextures = 1;
	const ShaderParamFlags flags = ShaderParamFlags::Header | ShaderParamFlags::Push;
	const PassResource textureResources[1] = {
...
struct RGMesh
{
	...
	const u32 numBuffers = 0;
	const u32 numTextures = 1;
	const ShaderParamFlags flags = ShaderParamFlags::Graphics | ShaderParamFlags::Push;
	const PassResource textureResources[1] = {
		{graphics::ResourceViewType::SRV, HLSLType::Texture2DArray, 1},
	};
	TextureView shadowMaps;
